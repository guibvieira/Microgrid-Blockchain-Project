...
class Agent{
    ...
    async purchaseLogic() {
        ...
        console.log('checking if has battery var exists', this.hasBattery);
        if(this.hasBattery == false){
            console.log('entering the doesnt have battery loop');
            if (excessEnergy > 0) {
    ...
    formulatePrice() {
            ...
            console.log(`the mean is ${mean} and stdev is ${stdev}`);
