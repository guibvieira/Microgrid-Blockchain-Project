...
class AgentBiomass {
    ...
    async deployContract() {
        let households = [];
        console.log('biomass address', this.ethereumAddress);
        ...
        try {
            ...
            console.log('error from creating biomass contract', err);
        }

        try {
            households = await factory.methods.getDeployedHouseholds().call();
        } catch (err) {
            console.log('error from deploying biomass getting existing households', err);
        }
        ...
        console.log('setting exchange in biomass');
        try {
            ...
            console.log('error from setting exchange in biomass agent', err);
        }
        ...
        try {
            ...
            console.log('error from setting initial deposit in biomass agent', err);
        }
